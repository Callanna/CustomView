...
public class NumberPickerView extends View {
    ...
    private static final int DEFAULT_TEXT_COLOR_NORMAL = 0xFFB0B0B0;

    // default text color of selected item
    private static final int DEFAULT_TEXT_COLOR_SELECTED = 0xFFF5C769;
    ...
    private static final int DEFAULT_MARGIN_START_OF_HINT_DP = 10;
    ...
    private void drawHint(Canvas canvas) {
        ...
        canvas.drawText(mHintText,
                mViewWidth - mWidthOfHintText/2,//靠右侧显示hint
...
//                (dividerY0 + dividerY1) / 2 + mTextSizeHintCenterYOffset, mPaintHint);
    ...
    public void updateContent(String[] newDisplayedValues) {
        mDisplayedValues = newDisplayedValues;
        updateWrapStateByContent();
    }
