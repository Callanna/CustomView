...
/**
 * Created by Callanna on 2016/9/27.
 */
public class CustomIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public CustomIndicator(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            fillColor = attributes.getColor(R.styleable.CustomIndicator_fillColor, Color.DKGRAY);
            strokeColor = attributes.getColor(R.styleable.CustomIndicator_strokeColor, Color.BLACK);
